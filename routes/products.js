...
// Thêm middleware isMod vào route post
router.post('/', require('../middleware/auth').isMod, async function(req, res, next) {
    try {
...
// Thêm middleware isMod vào route put
router.put('/:id', require('../middleware/auth').isMod, async function(req, res, next) {
    try {
        let updateObj = {};
        let body = req.body;
        if (body.name) {
...
// Thêm middleware isAdmin vào route delete
router.delete('/:id', require('../middleware/auth').isAdmin, async function(req, res, next) {
    try {
